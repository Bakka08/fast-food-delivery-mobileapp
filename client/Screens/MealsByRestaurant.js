...
const MealsByRestaurant = ({ navigation }) => {
  ...
  useEffect(() => {
    ...
    axios.get(`http://192.168.1.108:8080/api/meals/allbyrestaurant/${itemId}`)
      .then(response => {
    ...
    <View style={styles.container}>
      ...
      <FlatList
        ...
        renderItem={({ item }) => (
          ...
          <Text style={styles.cardText3}>{item.price}.00DH</Text>
...
export default MealsByRestaurant;
